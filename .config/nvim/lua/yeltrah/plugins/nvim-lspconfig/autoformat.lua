...
vim.keymap.set("n", "<leader>ft", ":FormatToggle<CR>", { desc = "Toggle Auto[f]ormatting" })
...
local get_augroup = function(client)
	if not _augroups[client.id] then
		local group_name = "yeltrah-lsp-format-" .. client.name
...
vim.api.nvim_create_autocmd("LspAttach", {
	group = vim.api.nvim_create_augroup("yeltrah-lsp-attach-format", { clear = true }),
